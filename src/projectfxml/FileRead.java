        ...
        try {
            ...
            while ((line = fileReader.readLine()) != null) {
                ...
                if (tokens.length > 0) {
                 ...
                 Vehicle v = new Vehicle(tokens[VIN_IDX], tokens[MAKE_IDX], tokens[MODEL_IDX], Integer.parseInt(tokens[YEAR_IDX]), tokens[TYPE_IDX], tokens[STATUS_IDX], Double.parseDouble(tokens[PRICE_IDX]));                   
                    vlist.add(v);
                }
            }
